...
from lavis.datasets.datasets.intentvc_video_caption_datasets import (
    IntentVCVideoCaptionDataset,
    IntentVCVideoCaptionEvalDataset
)
...
@registry.register_builder("intentvc_caption")
class IntentVCCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = IntentVCVideoCaptionDataset
    eval_dataset_cls = IntentVCVideoCaptionEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/intentvc/defaults_cap.yaml",
    }